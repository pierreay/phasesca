...
sig = np.load("lol/fc_2.528e9_sr_4e6_76db_coax-cable_leak-gio-firmware-fix-packet.npy")[500000:3500000]#[7*1000000:15*1000000]

#sig = np.load("record.npy")[52900:100000*2]

sig1, sig2 = sig[:1500000], sig[1700000:]
