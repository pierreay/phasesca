...
- Goal :: Test the (weighted ?) averaging of correlation coefficient given by 2
  channels.
- Recombination Method :: Just like POI recombination.
- Measure method :: Calculating key rank.
- Results :: N/C.
